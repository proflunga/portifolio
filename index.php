                  ...
                  <div class="timeline timeline-second-style clearfix">
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        ...
                        <span class="item-company">Catlas Tech</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Software engineer</h4>
                        <p>Help develop micro systems for the company and its clients. I also develop webste and do tech support to its respective clents like NGOs.</p>
                      </div>
                    </div>
