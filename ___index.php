...
<head>
  ...
  <title>Lunga Portifolio/</title>
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
  <meta name="description" content="BreezyCV - Resume / CV / vCard Template" />
  <meta name="keywords" content="vcard, resposnive, retina, resume, jquery, css3, bootstrap, Panashe CV,  Panashe Lunga CV, Panashe Lunga portfolio" />
...
<body>
            ...
            <div class="section-content">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-7">
                  <p>I am a talented software engineer with three years of experience, specializing in Python, JavaScript, HTML, CSS, and PHP. I have a passion for solving complex problems and developing cutting-edge business solutions. With a strong foundation in algorithm design and analysis, I am skilled in creating efficient and optimized solutions.</p>
                  <p>I am highly motivated to advance my skills and expertise through targeted mentorship and challenging projects. I have extensive experience with Flask and have recently started working with Django. Additionally, I am proficient in MySQL database management. With a focus on staying up-to-date with the latest industry trends, I am dedicated to continuous learning and growth as a software engineer. My goal is to make a meaningful impact in the software development industry by collaborating on impactful projects and contributing to innovative solutions.</p>
                  ...
                  <div class="info-list">
                    <ul>
                      ...
                      <li>
                        ...
                        <span class="value">3756, 271 Close Kuwadzana 3 Harare</span>
                      </li>

                      <li>
                        <span class="title">e-mail</span>
                        <span class="value"> panashe22lunga@gmail.com</span>
                      </li>

                      <li>
                        <span class="title">Phone</span>
                        <span class="value">+263 776 705 860</span>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div class="col-inner">
                    <div class="info-list-w-icon">
                      <div class="info-block-w-icon">
                        ...
                        <div class="ci-text">
                          <h4>Digital Business Software Solution</h4>
                          <p>I specialize in developing cutting-edge digital business software solutions that automate operations and maximize returns.</p>
                        </div>
                      </div>
                      <div class="info-block-w-icon">
                        <div class="ci-icon">
                        ...
                        <div class="ci-text">
                          ...
                          <p>As a skilled web developer, I create visually appealing and user-friendly websites using the latest design trends and technologies. I deliver captivating online experiences that engage users and drive business growth. Let's bring your ideas to life and establish a strong online presence.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="info-list-w-icon">
                      <div class="info-block-w-icon">
                        ...
                        <div class="ci-text">
                          ...
                          <p>Harness the power of custom software solutions. I specialize in designing and building scalable systems that optimize your business operations and drive growth. </p>
                        </div>
                      </div>
                      <div class="info-block-w-icon">
                        <div class="ci-icon">
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-4">
                  <div class="fun-fact gray-default">
                    ...
                    <h4>Working Hours</h4>
                    <span class="fun-fact-block-value">1,600</span>
                    <span class="fun-fact-block-text"></span>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-7">
                  ...
                  <div class="timeline timeline-second-style clearfix">
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        <h5 class="item-period">2019-2023</h5>
                        <span class="item-company">Harare Institute of Technology</span>
                      </div>
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        <h5 class="item-period">2013-2018</h5>
                        <span class="item-company">St Peter's Kubatana High School</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                  ...
                  <div class="timeline timeline-second-style clearfix">
                    ...
                    <div class="timeline-item clearfix">
                      ...
                      <div class="right-part">
                        ...
                        <p>As a dedicated freelancer at Catlas, I specialize in automating local business processes using Django, Flask, and PHP. With innovation at heart, I empower SMEs in Zimbabwe to establish strong digital footprints.</p>
                      </div>
                    </div>
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        ...
                        <span class="item-company">Aplimac</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Software Developer and Tech Support</h4>
                        <p>Worked as a software engineer developing business software solutions that automate business daily routines. We developed system such as ecommerce platform, workshop management, stores management and Pension Management system. I also worked on website design and development. Tech support was done on system installations and updates. I also worked on API development and integrations using PHP as my backend language and JavaScript as my frontend language.</p>
                      </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12">
                  ...
                  <div class="portfolio-content">
                    ...
                    <ul class="portfolio-filters">
                      ...
                      <li>
                        <a class="filter btn btn-sm btn-link" data-group="category_detailed">Systems</a>
                      </li>
                      <li>
                        <a class="filter btn btn-sm btn-link" data-group="category_mockups">Websites</a>
                      </li>
                      <!-- <li>
                    ...
                    <div class="portfolio-grid three-columns">
                      ...
                      <!-- START: TM MOBILE MECHANICS WEBSITE  -->

                      <figure class="item standard" data-groups='["category_all", "category_mockups"]'>
                        <div class="portfolio-item-img">
                          <img src="img/portfolio/Tmmobile1.png" alt="Media Project 2" title="" />
                          <a href="portfolio-5.html" class="ajax-page-load"></a>
                        </div>

                        <i class="far fa-file-alt"></i>
                        <h4 class="name">TM Mobile Mechanics Website</h4>
                        <span class="category">Detailed</span>
                      </figure>

                      <!-- END: TM MOBILE MECHANICS WEBSITE -->

                      <!-- START: TM MOBILE MECHANICS WEBSITE  -->

                      <figure class="item standard" data-groups='["category_all", "category_mockups"]'>
                        <div class="portfolio-item-img">
                          <img src="img/portfolio/meathub.png" alt="Media Project 2" title="" />
                          <a href="portfolio-6.html" class="ajax-page-load"></a>
                        </div>

                        <i class="far fa-file-alt"></i>
                        <h4 class="name">MeatHub Website</h4>
                        <span class="category">Detailed</span>
                      </figure>
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"76e97d945d759e95","version":"2022.11.3","r":1,"token":"94b99c0576dc45bf9d669fb5e9256829","si":100}' crossorigin="anonymous"></script>
</body>
